 ...
 * GitHub Auto-Updater
 *
 * Enables automatic updates from GitHub releases for Guilamu Bug Reporter.
 *
...
/**
 * Class Guilamu_Bug_Reporter_GitHub_Updater
 *
...
class Guilamu_Bug_Reporter_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'guilamu-bug-reporter';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'guilamu-bug-reporter/guilamu-bug-reporter.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'guilamu-bug-reporter';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'Guilamu Bug Reporter';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Unified bug reporting for all Guilamu plugins with AI-powered instant responses.';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'guilamu-bug-reporter';
     ...
     * @var string
     */
    private const CACHE_KEY = 'guilamu_bug_reporter_github_release';
     ...
     *
     * Prefers custom release assets (e.g., guilamu-bug-reporter.zip) over
